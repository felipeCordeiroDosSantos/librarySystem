...
router.get('/loanConsultation', (req, res, next) => res.render('loanConsultation'));
...
router.get('/customers', (req, res, next) => res.render('customers'));

router.get('/books', (req, res, next) => res.render('books'));
